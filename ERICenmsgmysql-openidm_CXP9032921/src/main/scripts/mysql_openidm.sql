-- Create openidm database
create database openidm;

-- Create users
CREATE USER 'root'@'openidm' IDENTIFIED BY 'MySqlAdm01';
CREATE USER 'openidm'@'localhost';
CREATE USER 'openidm'@'%';
CREATE USER 'root'@'%';
CREATE USER 'idmmysql'@'%';
CREATE USER 'idmmysql'@'localhost';

-- Grant permissions
GRANT ALL PRIVILEGES ON *.* TO 'root'@'localhost'  WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO '*'@'%' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'idmmysql'@'%' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'idmmysql'@'localhost' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'root'@'openidm' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'openidm'@'localhost' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'openidm'@'%' WITH GRANT OPTION;
GRANT SELECT, UPDATE ON *.* TO 'root'@'openidm';
GRANT SELECT, UPDATE ON *.* TO 'openidm'@'localhost';
GRANT SELECT, UPDATE ON *.* TO 'idmmysql'@'%';
GRANT SELECT, UPDATE ON *.* TO 'idmmysql'@'localhost';
GRANT SELECT, UPDATE ON *.* TO 'openidm'@'%';
GRANT SELECT, UPDATE ON *.* TO 'root'@'%';
GRANT SELECT, UPDATE ON *.* TO 'root'@'localhost';

flush privileges;
use mysql;
update user set password=PASSWORD('MysqlAdm01') where User='root';
flush privileges;
...
ALTER DATABASE openidm CHARACTER SET utf8 COLLATE utf8_bin;
USE `openidm` ;
